    ...
    public void doGet (HttpServletRequest request, HttpServletResponse response ) throws IOException, ServletException {
		...
		case "provincias":{
			...
			case "html":{
		    	...
		    	out.println("<html><head><title>Practica 4</title></head><body>");
				out.println("<h1>Provincias</h1>");
				out.println("<ul>");
				for (Provincia p:coleccProv) {
					//out.println("<li>"+p.toString()+"</li>"); 
					out.println("<li><a href=\"http://localhost:8080/practica4/Provincias?accion=municipios&provincia="+p.getCodigo()+"\">"+p.toString()+"</a></li>");
				}
				out.println("</ul>");
				break;
			}
